...
| **Native authoritative** | **PASS over 925 files, 0 mismatches** (current corpus; the earlier 2026-07-29 ratchet raised 906 → 916) | `bash scripts/run_native_authoritative_gate.sh` |
...
17. **`build` and `run` research CONSENT gap — SOURCE/VZ-CLOSED on the bounded dirty tree;
    ...
    epoch, compiler library **771/771**, language **257/257**, security **327/327**, stdlib
    ...
    a failed receipt, not promoted: security **327/327**, language **257/257**, stdlib fail-closed
    **104/104**; the current native-authoritative corpus is **925 files**, while that failed receipt
    ...
    **213 builtins**, while check/run parity and the documentation-coverage floor were RED. Phase 1
    ...
    to a whole-tree seal**: native-authoritative enumerated **925 files** from the live disk while the
...
21. **SIX items published as CLOSED are OPEN — 30 true accepts with runtime witnesses, survived
    ...
    **Row 8 — FIXED for annotated containers, clean-VM sealed, and landed in `03210603`
    ...
    | language corpus | **257/257** |
    | stdlib fail-closed | **104/104**, `timed_out=0` |
    | native-authoritative | current corpus **925 files**; this W1 receipt graded 916 files, 0 mismatches, 0 disagreements |
...
[receipt-scope: pre-fix-only; head: 0f407853; authority: none]
    ...
    **Bounded W1 receipt (2026-07-29, commit `03210603`).** This closes only the annotated
    ...
    | language | **257/257 PASS** |
    | stdlib fail-closed | **104/104 PASS** |
    | native-authoritative | current corpus **925 files**; this W1 receipt graded 916 files, 0 mismatches |
...
| Language core (fixtures + repro) | **257/257** on pinned instrument; `scripts/run_language_fixtures.sh` | Seal must set `ANUBIS_BIN` to same binary as security (CLAIMS §7); default is still DEBUG `cargo run` |
