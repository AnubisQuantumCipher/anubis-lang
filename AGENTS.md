...
security **299/299** · language **244/244** · stdlib fail-closed **104/104** · runtime 4/4 ·
selfhost 9/9 · taint/type/effect/capset self-host **0 disagreements** · formal gate PASS with every
theorem machine-checked and no `sorry`/`admit`/`axiom` · native-authoritative **870 files, 0
mismatches**.
