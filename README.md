...
| **Non-exportable linear caps** | ✅ | Static export-seal + interproc container stores; macOS runtime may bind NE to Keychain/SE (`kc:`/`se:` tokens, soft fallback); production SE still needs codesign |
